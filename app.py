...
TR_HITS = [
    ...
    "Tarkan", "Sertab Erener", "Kenan Dogulu","Tarkan", "Levent Yuksel", "Nazan Öncel", "Göksel"
]

EN_HITS = [
    "Nirvana", "Green Day", "Linkin Park", "Jeff Buckley","Elvis Presley", "Red Hot Chili Peppers", "Foo Fighters", "Queen", 
